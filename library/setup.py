...
setup(
    ...
    packages=['FaceEmotion4Lib'], #find_packages(where="FaceEmotion4Lib"),
    package_dir={'FaceEmotion4Lib':'FaceEmotion4Lib'},
    package_data = {
        # If any package contains *.txt or *.rst files, include them:
        #'': ['*.py','*.h5'],
        'FaceEmotion4Lib': ['*.py','models/*.h5']
    },
...
# Upload to PyPi
# or 
#! pip3 install dist/FaceEmotion4Lib-0.1.0.tar.gz 
