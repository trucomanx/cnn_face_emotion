...
#python3 kfold_validation.py --model mobilenet_v3        --dataset $DATASET --epochs 50  --batch-size 32
 python3 kfold_validation.py --model efficientnet_b3     --dataset $DATASET --epochs 50  --batch-size 16 #--model efficientnet_b3     --epochs 30  --batch-size 64
...
#python3 kfold_validation.py --model custom1             --dataset $DATASET --epochs 200 --batch-size 128 #--epochs 100  --batch-size 128
